                    ...
                    <div class="col-xl-6">
                        <div class="subscribe-one__left">
                            ...
                            <div class="subscribe-one__title-box">
                                <span class="subscribe-one__tagline">Indigoshopify</span>
                                <h2 class="subscribe-one__title">Your One-Stop Shop for Fresh Groceries!</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="subscribe-one__right">
                            ...
                            <div class="subscribe-one__form-box">
                                <h2 style="color:#ffffff;">Order Now for Fresh Groceries Delivered to Your Door!</h2>
