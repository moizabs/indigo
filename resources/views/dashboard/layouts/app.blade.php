                ...
                <div class="layout-width">
                    <div class="navbar-header">
                        <div class="d-flex">
                            ...
                            <h4 class="mb-sm-0 header-item page-title lh-base">{{ Auth::user()->role }}</h4>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown topbar-head-dropdown ms-1 header-item">
                                <span class="ms-2 fs-md fw-semibold">{{ Auth::user()->name }}</span>
                                <button type="button"
                                    ...
                                    {{-- Avatar Image --}}
                                    <img src="{{ asset('backend/assets/images/users/user-dummy-img.jpg') }}" alt="User Avatar"
                                    class="rounded-circle avatar-xs" style="height: 32px; width: 32px; object-fit: cover;">
                                </button>
...
<script>
    $('#delete-record').on('click', function () {
        ...
        $.ajax({
            url: '/admin/products/' + deleteId + '/deleteMainProduct',
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
            success: function (response) {
                ...
                $('[data-id="' + deleteId + '"]').closest('tr, .card, li').remove();
